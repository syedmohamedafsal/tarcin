...
! function(e, t, n) {
    ...
    function v(e, t, a, o) {
        ...
        for (var u, f, p, m, g, v = ["modernizr", "tspan", "samp"]; !G.style && v.length;) u = !0, G.modElem = s(v.shift()), G.style = G.modElem.style;
    ...
    var T = [],
        ...
        Modernizr = function() {};
    Modernizr.prototype = S, Modernizr = new Modernizr, Modernizr.addTest("sessionstorage", function() {
        var e = "modernizr";
        try {
    ...
    Modernizr.inputtypes = function(e) {
        for (var r, a, o, i = e.length, s = "1)", c = 0; i > c; c++) $.setAttribute("type", r = e[c]), o = "text" !== $.type && "style" in $, o && ($.value = s, $.style.cssText = "position:absolute;visibility:hidden;", /^range$/.test(r) && $.style.WebkitAppearance !== n ? (C.appendChild($), a = t.defaultView, o = a.getComputedStyle && "textfield" !== a.getComputedStyle($, null).WebkitAppearance && 0 !== $.offsetHeight, C.removeChild($)) : /^(search|tel)$/.test(r) || (o = /^(url|email)$/.test(r) ? $.checkValidity && $.checkValidity() === !1 : $.value != s)), O[e[c]] = !!o;
        return O
    }(M);
    var L = "autocomplete autofocus list placeholder max min multiple pattern required step".split(" "),
        B = {};
    Modernizr.input = function(t) {
        for (var n = 0, r = t.length; r > n; n++) B[t[n]] = !!(t[n] in $);
